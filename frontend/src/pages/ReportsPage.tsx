...
export const ReportsPage: React.FC = () => {
  ...
  const [dateFrom, setDateFrom] = useState<string | undefined>(getCurrentMonthRange().dateFrom);
  const [dateTo, setDateTo] = useState<string | undefined>(getCurrentMonthRange().dateTo);
  ...
  useEffect(() => {
    reportsService.getCategoryReport(categoryType, dateFrom, dateTo).then(setCategoryReport).catch(() => {});
  }, [categoryType, dateFrom, dateTo]);

  useEffect(() => {
    reportsService.getTimeline(groupBy, dateFrom, dateTo).then(setTimeline).catch(() => {});
  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card>
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold">Структура по категоріях</h2>
          ...
          <Card>
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold">Топ витрат</h2>
            </div>
        ...
        <Card>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold">Динаміка доходів та витрат</h2>
            <Select
              value={groupBy}
